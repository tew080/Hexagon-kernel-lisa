...
#define DEF_MAX_DISCARD_REQUEST		4	/* issue 8 discards per round */
#define DEF_MIN_DISCARD_ISSUE_TIME	100	/* 50 ms, if exists */
#define DEF_MID_DISCARD_ISSUE_TIME	1000	/* 500 ms, if device busy */
#define DEF_MAX_DISCARD_ISSUE_TIME	60000	/* 60 s, if no candidates */
#define DEF_DISCARD_URGENT_UTIL		80	/* do more discard over 80% */
#define DEF_CP_INTERVAL			30	/* 60 secs */
